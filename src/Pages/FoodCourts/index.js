                                            ...
                                            <div className="col-lg-4 col-md-6 col-xs-12">
                                                ...
                                                <div className="home__postsSection__categoryBoxes__basket">
                                                    ...
                                                    <div className="home__postsSection__categoryBoxes__itemImageBox">
                                                        <img src={`http://34.224.26.130${item.item_image[0].path}`} alt={item.name}
                                                    ...
                                                    <div className="home__postsSection__categoryBoxes__itemTitleBox">
                                                        <span className="home__postsSection__categoryBoxes__itemTitleBox__title"> <Link to={`/FoodCourt/${item.id}`}>{item.name}</Link> </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </>
